Name:           ros-hydro-irb-6640-moveit-config
Version:        1.1.6
Release:        0%{?dist}
Summary:        ROS irb_6640_moveit_config package
...
BuildRequires:  ros-hydro-abb-common
BuildRequires:  ros-hydro-catkin

%description
An automatically generated package with all the configuration and launch files
for using the irb_6640 with the MoveIt Motion Planning Framework (deprecated).
...
%changelog
* Tue Mar 17 2015 MoveIt Setup Assistant <assistant@moveit.ros.org> - 1.1.6-0
- Autogenerated by Bloom

* Tue Mar 17 2015 MoveIt Setup Assistant <assistant@moveit.ros.org> - 1.1.5-0
- Autogenerated by Bloom

* Sat Dec 27 2014 MoveIt Setup Assistant <assistant@moveit.ros.org> - 1.1.4-0
- Autogenerated by Bloom
